/*! Galactic starfield | canvas, 2D context, rAF
    140 stars, 3 depth layers, slow drift + twinkle. 3D parallax comes
    free from the existing hero transforms. Sleeps when the hero leaves
    the viewport. No-ops under prefers-reduced-motion. */
(function(){
  'use strict';
